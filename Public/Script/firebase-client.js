...
export function emailToRateLimitKey(email) {
    return String(email || "")
        .toLowerCase()
        .trim()
        .replace(/[^a-z0-9]/g, "_")
...
export function firestoreWithTimeout(promise, ms = 12000, message) {
    const text = message || "Request timed out. Check your connection and that Firestore is enabled in the cosname Firebase project.";
    let timer;
