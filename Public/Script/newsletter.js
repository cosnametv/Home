...
export function initNewsletterFeedbackOverlay() {
    ...
    const dismissBtn = overlay.querySelector(".site-feedback-overlay__dismiss");
    const iconOk = overlay.querySelector(".site-feedback-overlay__icon-success");
    const iconErr = overlay.querySelector(".site-feedback-overlay__icon-error");
    ...
    function show(variant, title, message) {
...
export function attachNewsletterForm() {
    ...
    form.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            feedback.show(
                "error",
                "Subscription failed",
                error && error.message ? String(error.message) : "Something went wrong. Please try again."
            );
        } finally {
