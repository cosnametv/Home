...
const linkResult = document.getElementById("link-result") as HTMLElement | null;
const shortUrl = document.getElementById("short-url") as HTMLAnchorElement | null;
const copyLinkBtn = document.getElementById("copy-link") as HTMLButtonElement | null;

const fileInput = document.getElementById("file") as HTMLInputElement | null;
const fileName = document.getElementById("file-name") as HTMLElement | null;
const uploadBtn = document.getElementById("upload") as HTMLButtonElement | null;
const imagePreview = document.getElementById("image-preview") as HTMLImageElement | null;
const imageResult = document.getElementById("image-result") as HTMLElement | null;
const imageUrl = document.getElementById("image-url") as HTMLAnchorElement | null;
const copyImageBtn = document.getElementById("copy-image") as HTMLButtonElement | null;
...
async function shortenLink(longUrl: string): Promise<string | null> {
  try {
  ...
  try {
    ...
    const data2 = (await res2.json()) as { shorturl?: string };
    if (data2?.shorturl) {
