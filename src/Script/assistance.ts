const toggleBtn = document.getElementById("chatToggle") as HTMLElement | null;
const chatWindow = document.getElementById("chatWindow") as HTMLElement | null;
const closeBtn = document.getElementById("chatClose") as HTMLElement | null;
const sendBtn = document.getElementById("chatSend") as HTMLElement | null;
const chatInput = document.getElementById("chatInput") as HTMLInputElement | HTMLTextAreaElement | null;
const chatBody = document.getElementById("chatBody") as HTMLElement | null;

if (toggleBtn && chatWindow && closeBtn && sendBtn && chatInput && chatBody) {
  ...
  function botReply(msg: string): string {
    ...
    if (msg.includes("where are you") || msg.includes("location") || msg.includes("based") || msg.includes("country") || msg.includes("city") || msg.includes("office") || msg.includes("address") || msg.includes("headquarters") || msg.includes("kenya") || msg.includes("nairobi") || msg.includes("africa")) {
      return "We're based in Nairobi and Thika, Kenya 🌍 but we work with clients worldwide through online communication. Our team operates remotely to serve you better! You can find us here: <a href='https://cosnametech.com/Contact' target='_blank'>contacts</a>. We're available during East Africa Time (EAT) but respond to messages promptly regardless of timezone.";
    }
    ...
    if (msg.includes("blog") || msg.includes("articles") || msg.includes("posts") || msg.includes("read") || msg.includes("resources") || msg.includes("learning")) {
      return "For learning resources and examples, check <a href='https://cosnametech.com/projects' target='_blank'>our projects page</a> and feel free to contact us for tailored recommendations.";
    }
